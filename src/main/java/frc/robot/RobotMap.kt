...
object RobotMap {
  ...
  val driveTrainLeftFront = 0 // CAN: 0
  val driveTrainLeftRear = 1 // CAN: 4

  val driveTrainRightFront = 2 // CAN: 2
  val driveTrainRightRear = 3 // CAN: 3
